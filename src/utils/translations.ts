export const translations = {
  es: {
    ...
    benefits: {
      ...
      items: {
        ...
        personalized: {
          ...
          description: 'Cuidado adaptado a necesidades específicas.'
        },
        security: {
    ...
    howItWorks: {
      title: '¿Cómo Funciona?',
      description: 'Nuestro proceso simple y efectivo',
      steps: {
        consultation: {
  ...
  en: {
    ...
    benefits: {
      ...
      items: {
        ...
        personalized: {
          ...
          description: 'Care adapted to specific needs.'
        },
        security: {
    ...
    howItWorks: {
      title: 'How It Works?',
      description: 'Our simple and effective process',
      steps: {
        consultation: {

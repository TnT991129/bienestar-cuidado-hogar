...
export default function PageNavigation() {
  ...
  return (
    <>
      ...
      <div className="hidden lg:block top-2/3 right-6 z-50 fixed -translate-y-1/3 transform">
        <motion.nav 
      ...
      <div className="lg:hidden top-22 right-0 left-0 z-40 fixed bg-white/95 shadow-sm backdrop-blur-sm border-gray-200/60 border-b">
